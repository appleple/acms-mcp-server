 ...
 * @returns スニペットデータ
 */
export async function loadSnippets(moduleName) {
    // キャッシュを確認
    ...
    try {
        ...
        throw new Error(`Failed to load snippets for module ${moduleName}: ${error instanceof Error ? error.message : String(error)}`);
    }
}
